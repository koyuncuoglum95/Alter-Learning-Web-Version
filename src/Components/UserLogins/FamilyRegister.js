...
const FamilyRegister = () => {
    ...
    return (
        <div>
            <Helmet>
                <title>Alter Learning Educational Platform - Family / Tutor Registration</title>
                    ...
                    <Container className="login_cont">
                        <Row>
                            <Col sm={8} className="left_side">
                                <img className="login_img" src={familyImg} />
                            </Col>
                            <Col sm={4} className="right_side">
                                <Form>
                                    <h1 className="teacher_register_txt">Register Family / Tutor Account</h1>
