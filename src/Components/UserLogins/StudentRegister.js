...
const StudnetRegister = () => {
    ...
    return (
        <div>
            <Helmet>
                <title>Alter Learning Educational Platform - Students Registration</title>
                    ...
                    <Container className="login_cont">
                        <Row>
                            <Col sm={8} className="left_side">
                                <img className="login_img" src={studentImg} />
                            </Col>
                            <Col sm={4} className="right_side">
                                <Form>
                                    <h1 className="teacher_register_txt">Register St Account</h1>
