...
import teacherRegisterImg from "./images/teacherRegisterImg.png"
                    ...
                    <Container className="login_cont">
                        <Row>
                            <Col sm={8} className="left_side">
                                <img className="login_img" src={teacherRegisterImg} />
                            </Col>
                            <Col sm={4} className="right_side">
                                <Form>
                                    <h1 className="teacher_register_txt">Register Teacher Account</h1>
